...
<n:form>
  ...
  <h3 id="workflow" class="menu_title">ワークフロー</h3>
  <ul>
  ...
  <h3 id="statemachine" class="menu_title">ステートマシン</h3>
  <ul>
    <li class="">
      <link:submit
          uri="/action/statemachine/CardAction/listCard"
          label="">
        <i class="fa fa-list-alt"></i>カード申し込み一覧
      </link:submit>
    </li>
    <li class="">
      <link:submit
          uri="/action/statemachine/CardAction/newCard"
          label="">
        <i class="fa fa-credit-card"></i>カード申し込み
      </link:submit>
    </li>
  </ul>
</n:form>
